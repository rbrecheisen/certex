...
def load_training_and_validation_data():
    ...
    return train_img_paths, train_lab_paths, validation_img_paths, validation_lab_paths
...
def main():
    ...
    train_img_paths, train_lab_paths, validation_img_paths, validation_lab_paths = load_training_and_validation_data()
    ...
    model.fit(train_data, epochs=15, validation_data=validation_data, callbacks=callbacks)
    model.save(MOD_DIR)
